...
RUN bash /tmp/develop.sh "$RUST_VERSION" "$RUSTUP_VERSION" "$CARGO_AUDIT_VERSION" "$CARGO_CYCLONEDX_VERSION" "$PREK_VERSION" "$CLAUDE_CODE_VERSION" "$SNIP_VERSION" "$RUSTFS_CLI_VERSION" "$UV_VERSION" "$PYTHON_VERSION" "$NODE_VERSION"
